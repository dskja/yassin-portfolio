                ...
                <section className={styles.modalContainer}>
                    <div className={styles.modal}>
                        ...
                        <div className={styles.header}>
                            ...
                            <h1>Contact Me</h1>
                            <p>Schreibe mir eine Nachricht und ich werde sobald wie möglich antworten.</p>
                        </div>
                        <form className={styles.form} onSubmit={handleSubmit}>
                            ...
                            <div className={styles.formGroup}>
                                ...
                                <input type="text" id="email" name="email" placeholder='Geben sie ihre Email-Adresse ein' />
                                <ValidationError
                                    prefix="Email"
                                    field="email"
                                    errors={state.errors}
                            ...
                            <div className={styles.formGroup}>
                                ...
                                <textarea type="text" id="message" rows={6} name="message" placeholder='Gib deine Nachricht ein' />
                                <ValidationError
                                    prefix="Message"
                                    field="message"
                                    errors={state.errors}
                            ...
                            <button disabled={state.submitting} type="submit" className={styles.submitButton}>Absenden</button>
                        </form>
                        {state.succeeded && (
                            <p className={styles.successMessage}>Vielen Dank für Ihre Kontaktaufnahme!</p>
                        )}
                    </div>
                </section>
            </> : null
